...
TEST_CASE("6test_decode2", "[weight=1]") {
	buildText2();
	HuffmanTree htree = constructTree( "tests/text.txt" );
...
TEST_CASE("7test_decode_readtree", "[weight=1]") {
	buildText();
...
TEST_CASE("8test_decode_readtree2", "[weight=1]") {
	buildText2();
...
TEST_CASE("9test_the_works", "[weight=1]") {
    buildText( 2 );
    encoder::encodeFile( "tests/text.txt", "tests/test.bin", "tests/tree.huff" );
