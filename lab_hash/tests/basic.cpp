...
TEST_CASE("testRemoveEASY", "[weight=1]")
{
...
TEST_CASE("testRemoveHard", "[weight=2]")
{
...
TEST_CASE("testResizeOnce", "[weight=1]" )
{
...
TEST_CASE("testResizeAll", "[weight=2]")
{
...
TEST_CASE("testInsertEasy", "[weight=1]")
{
	TextFile infile( "textEasy.txt" );
...
TEST_CASE("testInsertHard", "[weight=2]")
{
	TextFile infile( "textHard.txt" );
	LPHashTable<string, int> hashTable(32);
    int val = 0;
...
TEST_CASE("testWordCountSC", "[weight=1]")
{
...
TEST_CASE("testWordCountLP", "[weight=1]")
{
...
TEST_CASE("testAnagramsSC", "[weight=1]")
{
...
TEST_CASE("testAnagramsLP", "[weight=1]")
{
...
TEST_CASE("testLogfileParse", "[weight=3]")
{
