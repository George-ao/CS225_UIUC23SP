...
TEST_CASE("test_insert_small", "[weight=5]") {
    ...
    REQUIRE(tree_equals_output(str, "soln_test_insert_small.out") == true);
}
...
TEST_CASE("test_insert_big", "[weight=10][valgrind]") {
    ...
    REQUIRE(solnFuncCalls == funcCalls);
    REQUIRE(solnTraversal == inorderTraversal);
    REQUIRE(tree_equals_output(str, "soln_test_insert_big.out") == true);
}
...
TEST_CASE("test_remove_small", "[weight=5]") {
    ...
    REQUIRE(tree_equals_output(str, "soln_test_remove_small.out"));
}
...
TEST_CASE("test_remove_big", "[weight=10][valgrind]") {
    ...
    REQUIRE(tree_equals_output(str, "soln_test_remove_big.out"));
}
