...
class KDTree
{
  ...
  private:
    //store the vector
    vector<Point<Dim>> KDTree_vector ;
    /**
     * helper function for the constructor
     * @param KDTree_vector store the points in the vector.
     * @param cur_dim current dimension
     * @param left left index of the part
     * @param right right index of the part
     * @param subroot root of the subtree
     * @return null
     */
    void help_KDTree(vector<Point<Dim>>& KDTree_vector, int cur_dim,int left, int right,KDTreeNode* & subroot);

    /**
     * function for partition ;used in quickselect
     * @param KDTree_vector store the points in the vector.
     * @param left left index of the part
     * @param right right index of the part
     * @param cur_dim current dimension
     ...
     */
    int partition(vector<Point<Dim>>& KDTree_vector, int left, int right,int cur_dim);
    /**
     * function quickselect, find kth smallest
     * @param KDTree_vector store the points in the vector.
     * @param left left index of the part
     * @param right right index of the part
     * @param cur_dim current dimension
     * @return index of the pivot
     */
    int kthSmallest(vector<Point<Dim>>& KDTree_vector, int left, int right, int k, int cur_dim);

    /**
     *  helper function for findNearestNeighbor
     * @param query target point
     * @param node current node pointer
     * @param cur_dim current dimension
     * @param cloest cloest point
     * @param cur_rad radius square
     */
    void help_find(const Point<Dim>& query,KDTreeNode* node, int cur_dim,Point<Dim>& closest, double& cur_rad) const;

    /**
     *  helper function for destructor
     * @param subroot root of subtree
     */
     ...
     */
    KDTreeNode* copy(KDTreeNode* &root_1,const KDTreeNode* root_2);
