...
Graph PremadeGraphs::createJapanMap(bool isWeighted)
{
    ...
    /**
     * Creates a map of some China cities.
     * @param isWeighted - whether to show distance between
     *  cities in miles.
...
Graph PremadeGraphs::createChinaMap(bool isWeighted)
{
    ...
    string labels[] = {"Guangzhou","SHenzhen","Hongkong", "Shanghai", "Beijing", "Wuhan", "Chengdu","Chongqing", "Hangzhou", "Lasa"};
    ...
    g.insertEdge(vertices[0], vertices[1]);
    g.insertEdge(vertices[1], vertices[2]);
    g.insertEdge(vertices[0], vertices[7]);
    g.insertEdge(vertices[6], vertices[7]);
    g.insertEdge(vertices[6], vertices[9]);
    g.insertEdge(vertices[6], vertices[5]);
    g.insertEdge(vertices[5], vertices[8]);
    g.insertEdge(vertices[5], vertices[3]);
    g.insertEdge(vertices[4], vertices[5]);
    g.insertEdge(vertices[4], vertices[6]);

    if (isWeighted) {
        g.setEdgeWeight(vertices[0], vertices[1],2);
        g.setEdgeWeight(vertices[1], vertices[2],1);
        g.setEdgeWeight(vertices[0], vertices[7],30);
        g.setEdgeWeight(vertices[6], vertices[7],5);
        g.setEdgeWeight(vertices[6], vertices[9],35);
        g.setEdgeWeight(vertices[6], vertices[5],25);
        g.setEdgeWeight(vertices[5], vertices[8],17);
        g.setEdgeWeight(vertices[5], vertices[3],23);
        g.setEdgeWeight(vertices[4], vertices[5],29);
        g.setEdgeWeight(vertices[4], vertices[6],50);
    }
